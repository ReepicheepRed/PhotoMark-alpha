...
public class CommonTitleBar extends RelativeLayout {
    ...
    public CommonTitleBar(Context context, AttributeSet attrs) {
        ...
        LayoutInflater.from(context).inflate(R.layout.view_title_bar, this);
        findViewById(R.id.title_out_frame).setBackgroundResource(R.color.bar_black_c);
        ((TextView)findViewById(R.id.title_right)).setTextColor(getResources().getColor(R.color.bar_red_c));
        arr.recycle();
    }
