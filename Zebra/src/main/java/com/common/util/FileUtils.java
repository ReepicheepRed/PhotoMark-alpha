...
import com.sticker.app.model.PhotoItem;
...
public class FileUtils {
    ...
    public String getZebraPath() {
        return BASE_PATH;
    }
    public String getZebraPath(String fileName) {
    ...
    public static String
            ...
            Template_Puzzle = "Template_Puzzle",
            Template_Poster = "Template_Poster";

    public static String MarkSelf = "MarkSelf";

    public String getMarkMaterialPath() {
        return BASE_PATH + "Mark";
    }

    public String getLabelMaterialPath() {
        return BASE_PATH + "Label";
    }

    public String getLabelMaterialPath(String folder) {
        return getLabelMaterialPath() + "/" + folder;
    }
    ...
    private FileUtils() {
        ...
        if (Environment.MEDIA_MOUNTED.equals(sdcardState)) {
            BASE_PATH = Environment.getExternalStorageDirectory().getAbsolutePath()+ "/Zebra/";
        } else {
